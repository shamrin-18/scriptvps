#!/bin/bash
#shadowsocks-libev obfs install by shamrin
...
# Link Hosting Kalian
shamrin="raw.githubusercontent.com/shamrin-18/scriptvps/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${shamrin}/addss.sh"
wget -O delss "https://${shamrin}/delss.sh"
wget -O cekss "https://${shamrin}/cekss.sh"
wget -O renewss "https://${shamrin}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
