#!/bin/bash
#shadowsocks-libev obfs install by shamrin-18
...
# Link Hosting Kalian
shamrin-18="raw.githubusercontent.com/shamrin-18/scriptvps/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${shamrin-18}/addss.sh"
wget -O delss "https://${shamrin-18}/delss.sh"
wget -O cekss "https://${shamrin-18}/cekss.sh"
wget -O renewss "https://${shamrin-18}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
