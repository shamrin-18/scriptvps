...
# ==================================================
# Link Hosting Kalian
shamrin-18="raw.githubusercontent.com/shamrin-18/scriptvps/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${shamrin-18}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${shamrin-18}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${shamrin-18}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${shamrin-18}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${shamrin-18}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${shamrin-18}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/shamrin-18store/data-user-l2tp
touch /var/lib/shamrin-18store/data-user-pptp
rm -f /root/ipsec.sh
