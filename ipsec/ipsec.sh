...
# ==================================================
# Link Hosting Kalian
shamrin="raw.githubusercontent.com/shamrin-18/scriptvps/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${shamrin}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${shamrin}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${shamrin}/addpptp.sh && chmod +x /usr/bin/addpptp
